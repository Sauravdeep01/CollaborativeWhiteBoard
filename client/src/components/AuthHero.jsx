...
const AuthHero = () => (
    <div className="relative hidden lg:flex flex-col justify-between w-1/2 min-h-screen overflow-hidden bg-gradient-to-br from-slate-950 via-indigo-950 to-violet-950 p-12 text-white">
        <div
